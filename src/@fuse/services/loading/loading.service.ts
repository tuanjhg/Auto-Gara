...
{
    public _loadingApi$: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
    ...
    /**
     * Getter for loadingApi
     */
    get loadingApi$(): Observable<boolean>
    {
        return this._loadingApi$.asObservable();
    }
     ...
     * Show the loading bar
     */
    showMenu(isOpen: boolean): void
    {
        this._showMenu$.next(isOpen);
    }
    /**
     * Show the loading bar
     */
    showLoadingApi(isOpen: boolean): void
    {
        this._loadingApi$.next(isOpen);
    }
