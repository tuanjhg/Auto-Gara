...
{
    private _onMediaChange: ReplaySubject<{ matchingAliases: string[]; matchingQueries }> = new ReplaySubject<{ matchingAliases: string[]; matchingQueries }>(1);
     ...
     */
    get onMediaChange$(): Observable<{ matchingAliases: string[]; matchingQueries }>
    {
